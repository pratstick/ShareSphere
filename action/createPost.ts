...
export async function createPost({
  ...
  try {
    ...
    const postDoc: Partial<Post> = {
      ...
      helpType: (helpType || "request") as "request" | "offer", // Default to request if not specified
      category: (category || "other") as "grocery" | "pet-care" | "tech-support" | "home-garden" | "transportation" | "childcare" | "tutoring" | "repairs" | "food" | "deliveries" | "health" | "professional" | "events" | "books" | "other", // Default to other if not specified
