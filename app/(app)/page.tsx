    ...
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 py-8">
          <div className="text-center">
            ...
            <div className="flex gap-4 justify-center mb-8">
              ...
              <Button asChild variant="outline" className="border-orange-500 text-orange-400 hover:bg-orange-950/40 hover:text-orange-300">
            ...
            <div className="bg-card rounded-lg p-6 shadow-sm border border-border max-w-md mx-auto">
              <div className="flex items-center justify-center gap-2 text-green-400 mb-2">
                <MapPin className="w-5 h-5" />
                <span className="font-medium">Featured Neighborhood</span>
              </div>
              <h3 className="text-lg font-semibold text-foreground mb-2">Chandigarh</h3>
      ...
      <section className="my-8">
        <div className="mx-auto max-w-7xl px-4">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-foreground mb-2">Recent Community Activity</h2>
            <p className="text-muted-foreground">See how neighbors are helping each other across all neighborhoods</p>
          </div>
